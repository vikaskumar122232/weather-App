...
// get countries using function arow🤗☺️
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  //get list states by selecting countries 😅
  ...
  // get list cities by selecting state 😅 the city of jhumka = (Bareilly)
  ...
  // bhaii shashab net khatam 😅 select city
  ...
  // change unit Fahrenheit into Celsius 🧐
